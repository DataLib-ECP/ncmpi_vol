...
int main(int argc, char **argv) {  
    ...
    fatt_id = H5Acreate(file_id, "FileAtt", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT, H5P_DEFAULT);

    // Define group
    group_id = H5Gcreate2(file_id, "G", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT); 
    gatt_id = H5Acreate(group_id, "GroupAtt", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT, H5P_DEFAULT);

    // Define dataset
    dset_id  = H5Dcreate(group_id, "D", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);  
    datt_id = H5Acreate(dset_id, "DatasetAtt", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT, H5P_DEFAULT);
